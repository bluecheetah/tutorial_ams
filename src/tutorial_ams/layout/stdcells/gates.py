...
from ...schematic.inv import tutorial_ams__inv
...
class InvTristateCore(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        ...
        return ModuleDB.get_schematic_class('tutorial_ams', 'inv_tristate')
...
class NAND2Core(MOSBase):
    ...
    def get_schematic_class(cls) -> Optional[Type[Module]]:
        # noinspection PyTypeChecker
        return ModuleDB.get_schematic_class('tutorial_ams', 'nand')
